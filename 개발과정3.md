...
> <QueryDict: {'host': ['1'], 'event_name': ['image json test'], 'event_time': ['2020-07-30T00:00'], 'status': ['CLOSED'], 'event_place': 
> ['{"lat":37.4771237709505,"lng":126.890449586504,"name":"용"}'], 'message': [''], 'photo': [<InMemoryUploadedFile: 3_밝기지도zoom.png (image/png)>]}>



실제 데이터에 저장 후에 response에 담긴 데이터 에서도 아래와 같이 직렬화/역직렬화가 정상적으로 이루어졌음을 확인할 수 있었음.

> {"id":4,"event_name":"image json test","event_time":"2020-07-30T00:00:00+09:00","event_place":{"lat":37.4771237709505,"lng":126.890449586504,"name":"용"},"tags":{},"status":"CLOSED","message":"","photo":"https://bucket-simtime.s3.ap-northeast-2.amazonaws.com/media/ara/3_%EB%B0%9D%EA%B8%B0%EC%A7%80%EB%8F%84zoom-QkpIeUJz.png","created_at":"2020-07-30T23:41:11.557688+09:00","host":1}
